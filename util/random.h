 ...
 * @return Uniform value in [0, bound-1], or 0 if bound == 0 or r == NULL
 */
 ...
 */
static inline f64 random_f64(Random* r) {
 ...
 */
static inline i32 random_i32_range(Random* r, i32 min, i32 max) {
 ...
 */
static inline f32 random_f32_range(Random* r, f32 min, f32 max) {
 ...
 */
static inline f64 random_f64_range(Random* r, f64 min, f64 max) {

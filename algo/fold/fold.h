 ...
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * Generic level (ALGO_FOLD, ALGO_FOLD_RESULT macros):
 ...
 *
 * Typed slice level (generated per instantiation by DEFINE_ALGO_FOLD):
 *   algo_fold_fn_##type:          void (*)(void*, const type*, void*)
 *   algo_fold_result_fn_##type:   result_bool_Error (*)(void*, const type*, void*)
 *
 * These per-type typedefs are generated by DEFINE_ALGO_FOLD, enabling
 * borrowed() annotations on all function pointer parameters.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * API SUMMARY
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 *   algo_fold_result_fn_##type   — result_bool_Error (*)(void*, const type*, void*)
 *
 * These typedefs enable borrowed() annotations on all function pointer
 * parameters, consistent with algo_pred_fn and algo_cmp_fn in other modules.
 *
 * Generated functions:
 *   algo_fold_slice_##type(acc_ptr, sv, fn, ctx) → void
 *   algo_fold_result_slice_##type(acc_ptr, sv, fn, ctx) → result_bool_Error
...
typedef result_bool_Error (*algo_fold_result_fn_##type)(void*, const type*, void*); \
\
static inline void ALGO_FOLD_SLICE_FN(type)( \
    borrowed(void*)                        acc_ptr, \
    borrowed(slice_##type)                 sv, \
    borrowed(algo_fold_fn_##type)          fn, \
    borrowed(void*)                        ctx) \
{ \
...
static inline result_bool_Error ALGO_FOLD_RESULT_SLICE_FN(type)( \
    borrowed(void*)                        acc_ptr, \
    borrowed(slice_##type)                 sv, \
    borrowed(algo_fold_result_fn_##type)   fn, \
    borrowed(void*)                        ctx) \
{ \
    require_msg(acc_ptr != NULL, \
